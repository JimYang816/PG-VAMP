"""Independent NumPy verification of persisted WP6 acceptance artifacts."""
...
ROOT = Path("runs/wp6-check-cli")
OUT = Path(".trellis/tasks/09-18-wp6-training-checkpoint-smoke/research")
...
(OUT / "check-artifacts.json").write_text(json.dumps(result, indent=2) + "\n")
